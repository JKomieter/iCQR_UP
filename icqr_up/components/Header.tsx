...
const Header = () => {
    return (
        ...
        <nav className="bg-red-800 dark:bg-gray-900  w-full top-0 left-0 ">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="https://flowbite.com/" className="flex items-center">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">iCQR UP</span>
                </a>
                <div className="flex md:order-2">
                    <button type="button" className="text-white  hover:bg-[#660000] font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 bg-blue-700">Get started</button>
